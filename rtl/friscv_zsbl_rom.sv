...
initial begin
    ...
    mem[5] = 32'h1c45_0513;  // addi	x10,x10,452 # 11d4 <ready_msg>
    ...
    mem[12] = 32'h1b75_0513;  // addi	x10,x10,439 # 11e3 <dram_msg>
    ...
    mem[18] = 32'h1b35_0513;  // addi	x10,x10,435 # 11f7 <uart_msg>
    ...
    mem[25] = 32'h1ab5_0513;  // addi	x10,x10,427 # 120b <sd_msg>
    mem[26] = 32'h0740_00ef;  // jal	x1,10dc <uart_puts>
    mem[27] = 32'h1640_00ef;  // jal	x1,11d0 <sd_boot>
    ...
    mem[32] = 32'h1a15_0513;  // addi	x10,x10,417 # 121d <wait_msg>
    ...
    mem[82] = 32'h0430_0513;  // addi	x10,x0,67
    mem[83] = 32'hf61f_f0ef;  // jal	x1,10ac <uart_putc>
    mem[84] = 32'h0098_95b7;  // lui	x11,0x989
    mem[85] = 32'h6805_8593;  // addi	x11,x11,1664 # 989680 <UART_TIMEOUT_COUNT>
    mem[86] = 32'hfb9f_f0ef;  // jal	x1,1110 <uart_getc_timeout>
    mem[87] = 32'hfff0_0293;  // addi	x5,x0,-1
    mem[88] = 32'h0055_0463;  // beq	x10,x5,1168 <.xmodem_check_retry>
    mem[89] = 32'h0180_006f;  // jal	x0,117c <.check_char>
    mem[90] = 32'hfffb_8b93;  // addi	x23,x23,-1
    mem[91] = 32'hfc0b_9ee3;  // bne	x23,x0,1148 <.xmodem_start_retry>
    mem[92] = 32'h000a_0093;  // addi	x1,x20,0
    mem[93] = 32'h0000_8067;  // jalr	x0,0(x1)
    mem[94] = 32'hf4df_f0ef;  // jal	x1,10c4 <uart_getc>
    mem[95] = 32'h0040_0293;  // addi	x5,x0,4
    mem[96] = 32'h0455_0263;  // beq	x10,x5,11c4 <.transfer_done>
    mem[97] = 32'h0010_0293;  // addi	x5,x0,1
    mem[98] = 32'hfe55_18e3;  // bne	x10,x5,1178 <.next_packet>
    mem[99] = 32'hf39f_f0ef;  // jal	x1,10c4 <uart_getc>
    mem[100] = 32'hf35f_f0ef;  // jal	x1,10c4 <uart_getc>
    mem[101] = 32'h0800_0313;  // addi	x6,x0,128
    mem[102] = 32'hf2df_f0ef;  // jal	x1,10c4 <uart_getc>
    mem[103] = 32'h00aa_8023;  // sb	x10,0(x21) # 80000000 <DRAM_BASE>
    mem[104] = 32'h001a_8a93;  // addi	x21,x21,1
    mem[105] = 32'hfff3_0313;  // addi	x6,x6,-1
    mem[106] = 32'hfe03_18e3;  // bne	x6,x0,1198 <.check_char+0x1c>
    mem[107] = 32'hf19f_f0ef;  // jal	x1,10c4 <uart_getc>
    mem[108] = 32'hf15f_f0ef;  // jal	x1,10c4 <uart_getc>
    mem[109] = 32'h0060_0513;  // addi	x10,x0,6
    mem[110] = 32'hef5f_f0ef;  // jal	x1,10ac <uart_putc>
    mem[111] = 32'h001b_0b13;  // addi	x22,x22,1
    mem[112] = 32'hfb9f_f06f;  // jal	x0,1178 <.next_packet>
    mem[113] = 32'h0060_0513;  // addi	x10,x0,6
    mem[114] = 32'hee5f_f0ef;  // jal	x1,10ac <uart_putc>
    mem[115] = 32'hed9f_f06f;  // jal	x0,10a4 <execute_loaded>
    mem[116] = 32'h0000_8067;  // jalr	x0,0(x1)
    mem[117] = 32'h4253_5a5b;  // .word	0x42535a5b
    mem[118] = 32'h5220_5d4c;  // .word	0x52205d4c
    mem[119] = 32'h7964_6165;  // .word	0x79646165
    mem[120] = 32'h5b00_0a0d;  // .3byte	0x000a0d
    mem[121] = 32'h4c42_535a;  // 
    mem[122] = 32'h6f4d_205d;  // 
    mem[123] = 32'h203a_6564;  // 
    mem[124] = 32'h4d41_5244;  // 
    mem[125] = 32'h5b00_0a0d;  // 
    mem[126] = 32'h4c42_535a;  // 
    mem[127] = 32'h6f4d_205d;  // 
    mem[128] = 32'h203a_6564;  // 
    mem[129] = 32'h5452_4155;  // 
    mem[130] = 32'h5b00_0a0d;  // 
    mem[131] = 32'h4c42_535a;  // 
    mem[132] = 32'h6f4d_205d;  // 
    mem[133] = 32'h203a_6564;  // 
    mem[134] = 32'h0a0d_4453;  // 
    mem[135] = 32'h535a_5b00;  // 
    mem[136] = 32'h205d_4c42;  // 
    mem[137] = 32'h7469_6157;  // 
    mem[138] = 32'h2067_6e69;  // 
    mem[139] = 32'h2072_6f66;  // 
    mem[140] = 32'h304e_5442;  // 
    mem[141] = 32'h6572_7020;  // 
    mem[142] = 32'h0a0d_7373;  // 
    mem[143] = 32'h0001_0000;  // 
