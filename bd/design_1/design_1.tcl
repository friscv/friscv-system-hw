...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.C_BAUDRATE {110} $axi_uartlite_0
  ...
  connect_bd_intf_net -intf_net friscv_interconnect_M02_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins friscv_interconnect/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps_M_AXI_GP0 [get_bd_intf_pins debug_interconnect/S00_AXI] [get_bd_intf_pins ps/M_AXI_GP0]
  ...
  connect_bd_net -net friscv_rstn_gen_Res [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins friscv_gpio_0/s_axi_aresetn] [get_bd_pins friscv_interconnect/ARESETN] [get_bd_pins friscv_interconnect/M00_ARESETN] [get_bd_pins friscv_interconnect/M01_ARESETN] [get_bd_pins friscv_interconnect/M02_ARESETN] [get_bd_pins friscv_interconnect/S00_ARESETN] [get_bd_pins friscv_soc_wrapper/aresetn] [get_bd_pins gpio_aresetn/gpio_io_o] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net friscv_soc_wrapper_o_end [get_bd_ports done_out] [get_bd_pins friscv_soc_wrapper/done]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins debug_interconnect/ACLK] [get_bd_pins debug_interconnect/M00_ACLK] [get_bd_pins debug_interconnect/S00_ACLK] [get_bd_pins friscv_gpio_0/s_axi_aclk] [get_bd_pins friscv_interconnect/ACLK] [get_bd_pins friscv_interconnect/M00_ACLK] [get_bd_pins friscv_interconnect/M01_ACLK] [get_bd_pins friscv_interconnect/M02_ACLK] [get_bd_pins friscv_interconnect/S00_ACLK] [get_bd_pins friscv_soc_wrapper/aclk] [get_bd_pins gpio_aresetn/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps/FCLK_CLK0] [get_bd_pins ps/M_AXI_GP0_ACLK] [get_bd_pins ps/S_AXI_HP0_ACLK]
  ...
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps/Data] [get_bd_addr_segs gpio_aresetn/S_AXI/Reg] -force
